...
<template>
  <div class="login" id="login">
    ...
    <div class="log-bg">
      ...
      <div class="log-text" @click="goRegister">已注册？去登录</div>
    </div>
    <div class="log-email">
      <input
        type="text"
...
.log-cloud {
  background-image: url(@/assets/login/login-cloud.png);
  width: 63px;
  height: 40px;
  position: absolute;
  z-index: 1;
...
.icons {
  background: url(@/assets/login/icons.png) no-repeat;
